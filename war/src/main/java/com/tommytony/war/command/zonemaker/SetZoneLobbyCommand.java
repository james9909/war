...
public class SetZoneLobbyCommand extends AbstractZoneMakerCommand {
    ...
    public boolean handle() {
        ...
        if (zone == null) {
            ...
            if (!this.args[0].equals("north") && !this.args[0].equals("n") && !this.args[0].equals("east") && !this.args[0].equals("e") && !this.args[0].equals("south") && !this.args[0].equals("s")
                && !this.args[0].equals("west") && !this.args[0].equals("w")) {

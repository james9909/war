...
public class HubLobbyMaterials implements Cloneable {
    ...
    public HubLobbyMaterials(ItemStack floorBlock, ItemStack outlineBlock, ItemStack gateBlock, ItemStack lightBlock) {
        Validate.isTrue(floorBlock.getType().isBlock() || floorBlock.getType() == Material.AIR);
        Validate.isTrue(outlineBlock.getType().isBlock() || outlineBlock.getType() == Material.AIR);
        Validate.isTrue(gateBlock.getType().isBlock() || gateBlock.getType() == Material.AIR);

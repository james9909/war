...
public class Volume {
    ...
    public boolean contains(Location location) {
        ...
        return this.hasTwoCorners() && location.getWorld().getName().equals(this.world.getName()) && x <= this.getMaxX() && x >= this.getMinX() && y <= this.getMaxY() && y >= this.getMinY()
    ...
    public boolean contains(Block block) {
        ...
        int y = block.getY();
        int z = block.getZ();
        return this.hasTwoCorners() && block.getWorld().getName().equals(this.world.getName()) && x <= this.getMaxX() && x >= this.getMinX() && y <= this.getMaxY() && y >= this.getMinY() && z <= this
            .getMaxZ() && z >= this.getMinZ();
    }
